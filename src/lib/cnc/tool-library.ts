...
const TOOLS: ToolDefinition[] = [
  ...
  // ==========================================
  {
    ...
    defaultParams: {
      ...
      trochoidal: { feedRate: 800, spindleSpeed: 20000, depthOfCut: 0.5, stepover: 0.5, coolant: "mist" },
    },
  ...
  },
  {
    ...
    defaultParams: {
      ...
      trochoidal: { feedRate: 1800, spindleSpeed: 9000, depthOfCut: 1.5, stepover: 0.8, coolant: "flood" },
    },
  ...
  // ==========================================
  {
    ...
    defaultParams: {
      ...
      plunge: { feedRate: 800, spindleSpeed: 3500, depthOfCut: 2, coolant: "flood" },
    },
